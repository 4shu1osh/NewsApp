      ...
      <SafeAreaView style={{ flex: 1 }} >
        ...
        <View style={{ flex: 1, }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center', backgroundColor: 'black' }}>
            <Text style={{ color: 'orange', fontSize: 30, fontWeight: 'bold', marginBottom: 20 }}>{"News"}</Text>
            <Text style={{ color: 'black', backgroundColor: 'orange', fontSize: 30, fontWeight: 'bold', marginBottom: 20, borderRadius: 5, overflow: 'hidden' }}>{"hub"}</Text>
          </View>
          <SectionList
            style={{ flex: 1 }}
            sections={formatData()}
